          ...
          <div className="container px-4 mx-auto sm:px-6 lg:px-8">
            ...
            {!loading && !error && (
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                ...
                <article
                  key={post.slug}
                  className="group relative p-6 rounded-xl bg-[#0A0A0A]/70 backdrop-blur-sm border border-[#77001A]/20 hover:border-[#77001A]/60 transition-all duration-300"
                  data-aos="fade-up">
                  <div className="absolute -inset-0.5 bg-gradient-to-r from-[#330008] to-[#77001A] rounded-xl blur opacity-10 pointer-events-none" />
